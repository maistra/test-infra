...
ENV PROTOC_GEN_VALIDATE_VERSION=v1.0.1
...
ENV K8S_TEST_INFRA_VERSION=60794d470c0fb4da1fb14b4fd1abb80307c1e128
ENV BUF_VERSION=v1.21.0
ENV GCLOUD_VERSION=435.0.0
