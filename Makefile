...
BUILD_IMAGE_VERSIONS = $(BUILD_IMAGE)_3.4 $(BUILD_IMAGE)_3.3 $(BUILD_IMAGE)_3.2 $(BUILD_IMAGE)_3.1 $(BUILD_IMAGE)_3.0 $(BUILD_IMAGE)_2.6 $(BUILD_IMAGE)_2.5 $(BUILD_IMAGE)_2.4 $(BUILD_IMAGE)_2.3 $(BUILD_IMAGE)_2.2 $(BUILD_IMAGE)_main
