...
BUILD_IMAGE_VERSIONS = $(BUILD_IMAGE)_2.1-1.9 $(BUILD_IMAGE)_2.1 $(BUILD_IMAGE)_2.0
...
build-containers: maistra-builder
	docker run --privileged -v ${PWD}:/work --workdir /work ${HUB}/maistra-builder:2.1-1.9 make maistra-builder_2.1-1.9
